...
/* Includes ------------------------------------------------------------------*/
#include "ble.h"  // For tBleStatus and BLE types
...
/* Exported constants --------------------------------------------------------*/
#define GATT_CLT_MAX_NUM_SERVERS                           (2)
/* USER CODE BEGIN EC */
...
/* USER CODE BEGIN EFP */
void scanStart(void);  // Test function for manual scan triggering
tBleStatus GATT_CLIENT_SubscribeToPeerTemperature(uint16_t peer_conn_handle);  // Subscribe to peer temperature
/* USER CODE END EFP */
